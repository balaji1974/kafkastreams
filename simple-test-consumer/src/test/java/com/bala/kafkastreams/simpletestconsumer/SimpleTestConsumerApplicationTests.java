package com.bala.kafkastreams.simpletestconsumer;
...
@DirtiesContext
@SpringBootTest( // To disable the embedded tomcat
        webEnvironment = SpringBootTest.WebEnvironment.NONE,
        properties = {"server.port=0"})
public class SimpleTestConsumerApplicationTests {

	// to start Embedded Kafka for testing purpose
	@ClassRule
    ...
    // This will automatically start the Kafka Streams application 
    @Autowired
    StreamsBuilderFactoryBean streamsBuilderFactoryBean;
    
    
    // Setup the consumer default configurations 
    @BeforeClass
    ...
    // Close the consumer before the application stop 
    @AfterClass
